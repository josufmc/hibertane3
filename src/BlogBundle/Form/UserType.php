...
class UserType extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        $builder->add('name', TextType::class, array('required' => 'required', 'label' => 'Nombre',
                    'attr' => array('class' => 'form-name form-control')))
                ->add('surname', TextType::class, array('required' => 'required', 'label' => 'Apellidos',
                    'attr' => array('class' => 'form-surname form-control')))
                ->add('email', EmailType::class, array('required' => 'required', 'label' => 'Email',
